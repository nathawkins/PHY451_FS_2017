...
class Fit(object):
    ...
    def DisplayFit(self,po=PlotOptions(),saveFile=None,showData=True,errors=True):
        ...
        if showData:
            if errors:
                ...
                line1, = plt.plot(self.data.X,self.data.Y,po.pt_fmt)
            line1.set_label('Data')
    ...
    def DisplayResiduals(self,po=PlotOptions(),saveFile=None,errors=True):
        ...
        if errors:
            ...
            line, = plt.plot(self.data.X,self.residuals,po.pt_fmt)
...
def DisplayData(data,po=PlotOptions(),saveFile=None,errors=True):
    """Displays the plot of the data points
    Parameters:
        po - (optional) PlotOptions, configure how the plot is displayed
        saveFile - (optional) string, name of the image file to save the plot as"""
    ...
    if errors:
        ...
        line1, = plt.plot(data.X,data.Y,po.pt_fmt)
    line1.set_label('Data')
